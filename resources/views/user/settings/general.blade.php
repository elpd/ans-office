    ...
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
        ...
        <div class="panel panel-default" id="section_settings_user_name">
            <div class="panel-heading" role="tab" id="section_settings_user_name_heading">
                <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#section_settings_user_name_content"
                       aria-expanded="true"
            ...
            <div id="section_settings_user_name_content" class="panel-collapse collapse panel-content" role="tabpanel"
        ...
        <div class="panel panel-default" id="section_settings_user_email">
            <div class="panel-heading" role="tab" id="section_settings_user_email_heading">
                <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#section_settings_user_email_content"
                       aria-expanded="true"
            ...
            <div id="section_settings_user_email_content" class="panel-collapse collapse " role="tabpanel"
        ...
        <div class="panel panel-default" id="section_settings_user_password">
            <div class="panel-heading" role="tab" id="section_settings_user_password_heading">
                <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#section_settings_user_password_content"
                       aria-expanded="true"
